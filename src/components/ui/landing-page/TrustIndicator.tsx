      ...
      <div className="lg:w-3/5 py-14 px-8 border border-b-0 border-t-0 border-l-0 border-zinc-200 dark:border-none">
        ...
        <div className="flex flex-col sm:flex-row justify-between md:justify-start gap-4">
          <button
            ...
            className="bg-purple-600 cursor-pointer dark:bg-purple-500 w-full sm:w-auto text-white font-semibold py-3 px-8 rounded-md hover:bg-purple-700 dark:hover:bg-purple-600 transition"
          >
            Reserve My Username
          </button>
          <button className="bg-purple-50 cursor-pointer dark:bg-zinc-800 w-full sm:w-auto text-purple-600 dark:text-purple-400 font-semibold py-3 px-8 rounded-md hover:bg-purple-100 dark:hover:bg-zinc-700 transition">
            Learn More
          </button>
        </div>
      </div>
